...
> _**NOTE:** Our reads are only 36 bp, so technically we should use Bowtie1. However, since it is rare that you will have reads less than 50 bp, we will use Bowtie2 to go through all of the parameters._
