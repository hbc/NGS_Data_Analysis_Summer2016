...
1. [Download Sailfish files](https://www.dropbox.com/s/2gjw4rxu5sdgtip/sailfish.zip?dl=0)
2. Decompress the tar archive
3. Open RStudio
4. Go to the files tab and find your way to the new folder you downloaded
5. Set that folder your working directory
