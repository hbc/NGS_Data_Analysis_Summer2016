...
Copy and paste the genes in `Mov10_kd_logFC_1_pVal_0.05.txt`in the `DEanalysis/results` directory and paste it in the `Query' box. *If you do not have this file, you can download it using this [link]().*
